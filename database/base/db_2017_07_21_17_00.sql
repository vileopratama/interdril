...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 21, 2017 at 11:24 AM
...
(14, 'interdril.module.slideshows', 1, 1);
...
(35, 35, '2017-07-21 08:43:07', 1, '2017-07-21 08:55:49', 1, NULL, 'sl01.png', 1, 6, 'png', 1565088, 'image/png', NULL, 'Anomaly\\Streams\\Platform\\Model\\Files\\FilesSlideshowsEntryModel', NULL, '897', '1811'),
(36, 36, '2017-07-21 08:55:56', 1, '2017-07-21 08:55:57', 1, NULL, 'sl02.png', 1, 6, 'png', 1370189, 'image/png', NULL, 'Anomaly\\Streams\\Platform\\Model\\Files\\FilesSlideshowsEntryModel', NULL, '828', '1881'),
(37, 37, '2017-07-21 09:02:45', 1, '2017-07-21 09:02:46', 1, NULL, 'slide04.png', 1, 7, 'png', 40322, 'image/png', NULL, 'Anomaly\\Streams\\Platform\\Model\\Files\\FilesPromisesEntryModel', NULL, '256', '256'),
(38, 38, '2017-07-21 09:02:45', 1, NULL, NULL, NULL, 'slide02.png', 1, 7, 'png', 40521, 'image/png', NULL, 'Anomaly\\Streams\\Platform\\Model\\Files\\FilesPromisesEntryModel', NULL, '256', '256'),
(39, 39, '2017-07-21 09:02:45', 1, '2017-07-21 09:02:54', 1, NULL, 'slide01.png', 1, 7, 'png', 42990, 'image/png', NULL, 'Anomaly\\Streams\\Platform\\Model\\Files\\FilesPromisesEntryModel', NULL, '256', '256'),
(40, 40, '2017-07-21 09:02:54', 1, '2017-07-21 09:02:54', 1, NULL, 'slide03.png', 1, 7, 'png', 40223, 'image/png', NULL, 'Anomaly\\Streams\\Platform\\Model\\Files\\FilesPromisesEntryModel', NULL, '256', '256'),
(41, 41, '2017-07-21 09:02:54', 1, '2017-07-21 09:02:55', 1, NULL, 'slide05.png', 1, 7, 'png', 80527, 'image/png', NULL, 'Anomaly\\Streams\\Platform\\Model\\Files\\FilesPromisesEntryModel', NULL, '256', '256'),
(42, 42, '2017-07-21 09:13:59', 1, '2017-07-21 09:13:59', 1, NULL, 'service_slide_001.png', 1, 5, 'png', 507241, 'image/png', NULL, 'Anomaly\\Streams\\Platform\\Model\\Files\\FilesServicesEntryModel', NULL, '650', '700'),
(43, 43, '2017-07-21 09:13:59', 1, '2017-07-21 09:14:00', 1, NULL, 'service_slide_003.png', 1, 5, 'png', 506147, 'image/png', NULL, 'Anomaly\\Streams\\Platform\\Model\\Files\\FilesServicesEntryModel', NULL, '650', '700'),
(44, 44, '2017-07-21 09:13:59', 1, '2017-07-21 09:14:01', 1, NULL, 'service_slide_002.png', 1, 5, 'png', 697868, 'image/png', NULL, 'Anomaly\\Streams\\Platform\\Model\\Files\\FilesServicesEntryModel', NULL, '650', '700');
...
(6, 6, '2017-07-21 08:42:48', 1, NULL, NULL, NULL, 1, 'slideshows', 'a:0:{}'),
(7, 7, '2017-07-21 09:01:42', 1, NULL, NULL, NULL, 1, 'promises', 'a:0:{}');
...
(6, 6, '2017-07-21 08:42:49', NULL, '2017-07-21 08:42:49', 1, 'en', 'Slideshows', 'Slideshows Image'),
(7, 7, '2017-07-21 09:01:44', NULL, '2017-07-21 09:01:44', 1, 'en', 'Promises', 'Promises');
...
--
-- Table structure for table `interdril_files_promises`
--

CREATE TABLE `interdril_files_promises` (
  `id` int(10) UNSIGNED NOT NULL,
  `sort_order` int(11) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `interdril_files_promises_translations`
--

CREATE TABLE `interdril_files_promises_translations` (
  `id` int(10) UNSIGNED NOT NULL,
  `entry_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `interdril_files_slideshows`
--

CREATE TABLE `interdril_files_slideshows` (
  `id` int(10) UNSIGNED NOT NULL,
  `sort_order` int(11) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `interdril_files_slideshows_translations`
--

CREATE TABLE `interdril_files_slideshows_translations` (
  `id` int(10) UNSIGNED NOT NULL,
  `entry_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
(53, '2017_07_19_044435_interdril.module.slideshows__create_slideshows_fields', 15),
(54, '2017_07_21_073012_interdril.module.slideshows__create_slideshows_stream', 15),
(55, '2017_07_21_073133_interdril.module.slideshows__create_promises_stream', 15),
(56, '2017_07_21_073201_interdril.module.slideshows__create_services_stream', 15),
(57, '2017_07_21_073221_interdril.module.slideshows__create_products_stream', 15),
(58, '2017_07_21_073234_interdril.module.slideshows__create_partners_stream', 15);
...
--
-- Table structure for table `interdril_slideshows_partners`
--

CREATE TABLE `interdril_slideshows_partners` (
  `id` int(10) UNSIGNED NOT NULL,
  `sort_order` int(11) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `interdril_slideshows_partners_translations`
--

CREATE TABLE `interdril_slideshows_partners_translations` (
  `id` int(10) UNSIGNED NOT NULL,
  `entry_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `interdril_slideshows_products`
--

CREATE TABLE `interdril_slideshows_products` (
  `id` int(10) UNSIGNED NOT NULL,
  `sort_order` int(11) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `interdril_slideshows_products_translations`
--

CREATE TABLE `interdril_slideshows_products_translations` (
  `id` int(10) UNSIGNED NOT NULL,
  `entry_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `interdril_slideshows_promises`
--

CREATE TABLE `interdril_slideshows_promises` (
  `id` int(10) UNSIGNED NOT NULL,
  `sort_order` int(11) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `interdril_slideshows_promises`
--

INSERT INTO `interdril_slideshows_promises` (`id`, `sort_order`, `created_at`, `created_by_id`, `updated_at`, `updated_by_id`, `slug`, `image_id`, `publish`) VALUES
(1, 1, '2017-07-21 09:04:24', 1, NULL, NULL, 'high-technology', 39, 1),
(2, 2, '2017-07-21 09:05:28', 1, NULL, NULL, 'team-works', 38, 1),
(3, 3, '2017-07-21 09:06:00', 1, NULL, NULL, 'integrity', 40, 1),
(4, 4, '2017-07-21 09:07:07', 1, NULL, NULL, 'ready-representative', 37, 1),
(5, 5, '2017-07-21 09:07:33', 1, NULL, NULL, 'fast-response', 41, 1);

-- --------------------------------------------------------

--
-- Table structure for table `interdril_slideshows_promises_translations`
--

CREATE TABLE `interdril_slideshows_promises_translations` (
  `id` int(10) UNSIGNED NOT NULL,
  `entry_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `interdril_slideshows_promises_translations`
--

INSERT INTO `interdril_slideshows_promises_translations` (`id`, `entry_id`, `created_at`, `created_by_id`, `updated_at`, `updated_by_id`, `locale`, `title`) VALUES
(1, 1, '2017-07-21 09:04:25', NULL, '2017-07-21 09:04:25', 1, 'en', 'High Technology'),
(2, 2, '2017-07-21 09:05:29', NULL, '2017-07-21 09:05:29', 1, 'en', 'Team Works'),
(3, 3, '2017-07-21 09:06:00', NULL, '2017-07-21 09:06:00', 1, 'en', 'Integrity'),
(4, 4, '2017-07-21 09:07:08', NULL, '2017-07-21 09:07:08', 1, 'en', 'Ready Representative'),
(5, 5, '2017-07-21 09:07:33', NULL, '2017-07-21 09:07:33', 1, 'en', 'Fast Response');

-- --------------------------------------------------------

--
-- Table structure for table `interdril_slideshows_services`
--

CREATE TABLE `interdril_slideshows_services` (
  `id` int(10) UNSIGNED NOT NULL,
  `sort_order` int(11) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `interdril_slideshows_services`
--

INSERT INTO `interdril_slideshows_services` (`id`, `sort_order`, `created_at`, `created_by_id`, `updated_at`, `updated_by_id`, `slug`, `image_id`, `url`, `publish`) VALUES
(1, 1, '2017-07-21 09:14:43', 1, NULL, NULL, 'crane-rental', 42, 'http://beta-interdril-indonesia.com/services/crane-rental', 1),
(2, 2, '2017-07-21 09:18:52', 1, NULL, NULL, 'full-casing-oscilattor', 44, 'http://beta-interdril-indonesia.com/services/full-cassing-oscillator', 1),
(3, 3, '2017-07-21 09:20:14', 1, NULL, NULL, 'soil-improvement', 43, 'http://beta-interdril-indonesia.com/services/soil-improvement', 1);

-- --------------------------------------------------------

--
-- Table structure for table `interdril_slideshows_services_translations`
--

CREATE TABLE `interdril_slideshows_services_translations` (
  `id` int(10) UNSIGNED NOT NULL,
  `entry_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `interdril_slideshows_services_translations`
--

INSERT INTO `interdril_slideshows_services_translations` (`id`, `entry_id`, `created_at`, `created_by_id`, `updated_at`, `updated_by_id`, `locale`, `title`) VALUES
(1, 1, '2017-07-21 09:14:45', NULL, '2017-07-21 09:14:45', 1, 'en', 'Crane Rental'),
(2, 2, '2017-07-21 09:18:53', NULL, '2017-07-21 09:18:53', 1, 'en', 'Full Casing Oscilattor'),
(3, 3, '2017-07-21 09:20:15', NULL, '2017-07-21 09:20:15', 1, 'en', 'Soil Improvement');

-- --------------------------------------------------------

--
-- Table structure for table `interdril_slideshows_slideshows`
--

CREATE TABLE `interdril_slideshows_slideshows` (
  `id` int(10) UNSIGNED NOT NULL,
  `sort_order` int(11) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `interdril_slideshows_slideshows`
--

INSERT INTO `interdril_slideshows_slideshows` (`id`, `sort_order`, `created_at`, `created_by_id`, `updated_at`, `updated_by_id`, `slug`, `image_id`, `publish`) VALUES
(1, 1, '2017-07-21 08:43:30', 1, '2017-07-21 08:56:12', 1, 'slide-01', 35, 1),
(2, 2, '2017-07-21 08:58:54', 1, NULL, NULL, 'slide-02', 36, 1);

-- --------------------------------------------------------

--
-- Table structure for table `interdril_slideshows_slideshows_translations`
--

CREATE TABLE `interdril_slideshows_slideshows_translations` (
  `id` int(10) UNSIGNED NOT NULL,
  `entry_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `created_by_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `interdril_slideshows_slideshows_translations`
--

INSERT INTO `interdril_slideshows_slideshows_translations` (`id`, `entry_id`, `created_at`, `created_by_id`, `updated_at`, `updated_by_id`, `locale`, `title`) VALUES
(1, 1, '2017-07-21 08:43:31', NULL, '2017-07-21 08:43:31', 1, 'en', 'Slide 01'),
(2, 2, '2017-07-21 08:58:55', NULL, '2017-07-21 08:58:55', 1, 'en', 'Slide 02');
...
(134, 130, 29, 123, 'a:0:{}', 0, 1, 1),
(135, 131, 29, 125, 'a:0:{}', 1, 1, 0),
(136, 132, 29, 127, 'a:0:{}', 0, 1, 0),
(137, 133, 29, 126, 'a:0:{}', 0, 1, 0),
(138, 134, 30, 123, 'a:0:{}', 0, 1, 1),
(139, 135, 30, 125, 'a:0:{}', 1, 1, 0),
(140, 136, 30, 127, 'a:0:{}', 0, 1, 0),
(141, 137, 30, 126, 'a:0:{}', 0, 1, 0),
(142, 138, 31, 123, 'a:0:{}', 0, 1, 1),
(143, 139, 31, 125, 'a:0:{}', 1, 1, 0),
(144, 140, 31, 127, 'a:0:{}', 0, 1, 0),
(145, 141, 31, 128, 'a:0:{}', 0, 1, 0),
(146, 142, 31, 126, 'a:0:{}', 0, 1, 0),
(147, 143, 32, 123, 'a:0:{}', 0, 1, 1),
(148, 144, 32, 125, 'a:0:{}', 1, 1, 0),
(149, 145, 32, 127, 'a:0:{}', 0, 1, 0),
(150, 146, 32, 128, 'a:0:{}', 0, 1, 0),
(151, 147, 32, 126, 'a:0:{}', 0, 1, 0),
(152, 148, 33, 127, 'a:0:{}', 0, 1, 0),
(153, 149, 33, 126, 'a:0:{}', 0, 1, 0);
...
(134, 134, 'en', 'interdril.module.slideshows::field.title.label.slideshows', 'interdril.module.slideshows::field.title.warning.slideshows', 'interdril.module.slideshows::field.title.placeholder.slideshows', 'interdril.module.slideshows::field.title.instructions.slideshows'),
(135, 135, 'en', 'interdril.module.slideshows::field.slug.label.slideshows', 'interdril.module.slideshows::field.slug.warning.slideshows', 'interdril.module.slideshows::field.slug.placeholder.slideshows', 'interdril.module.slideshows::field.slug.instructions.slideshows'),
(136, 136, 'en', 'interdril.module.slideshows::field.image.label.slideshows', 'interdril.module.slideshows::field.image.warning.slideshows', 'interdril.module.slideshows::field.image.placeholder.slideshows', 'interdril.module.slideshows::field.image.instructions.slideshows'),
(137, 137, 'en', 'interdril.module.slideshows::field.publish.label.slideshows', 'interdril.module.slideshows::field.publish.warning.slideshows', 'interdril.module.slideshows::field.publish.placeholder.slideshows', 'interdril.module.slideshows::field.publish.instructions.slideshows'),
(138, 138, 'en', 'interdril.module.slideshows::field.title.label.promises', 'interdril.module.slideshows::field.title.warning.promises', 'interdril.module.slideshows::field.title.placeholder.promises', 'interdril.module.slideshows::field.title.instructions.promises'),
(139, 139, 'en', 'interdril.module.slideshows::field.slug.label.promises', 'interdril.module.slideshows::field.slug.warning.promises', 'interdril.module.slideshows::field.slug.placeholder.promises', 'interdril.module.slideshows::field.slug.instructions.promises'),
(140, 140, 'en', 'interdril.module.slideshows::field.image.label.promises', 'interdril.module.slideshows::field.image.warning.promises', 'interdril.module.slideshows::field.image.placeholder.promises', 'interdril.module.slideshows::field.image.instructions.promises'),
(141, 141, 'en', 'interdril.module.slideshows::field.publish.label.promises', 'interdril.module.slideshows::field.publish.warning.promises', 'interdril.module.slideshows::field.publish.placeholder.promises', 'interdril.module.slideshows::field.publish.instructions.promises'),
(142, 142, 'en', 'interdril.module.slideshows::field.title.label.services', 'interdril.module.slideshows::field.title.warning.services', 'interdril.module.slideshows::field.title.placeholder.services', 'interdril.module.slideshows::field.title.instructions.services'),
(143, 143, 'en', 'interdril.module.slideshows::field.slug.label.services', 'interdril.module.slideshows::field.slug.warning.services', 'interdril.module.slideshows::field.slug.placeholder.services', 'interdril.module.slideshows::field.slug.instructions.services'),
(144, 144, 'en', 'interdril.module.slideshows::field.image.label.services', 'interdril.module.slideshows::field.image.warning.services', 'interdril.module.slideshows::field.image.placeholder.services', 'interdril.module.slideshows::field.image.instructions.services'),
(145, 145, 'en', 'interdril.module.slideshows::field.url.label.services', 'interdril.module.slideshows::field.url.warning.services', 'interdril.module.slideshows::field.url.placeholder.services', 'interdril.module.slideshows::field.url.instructions.services'),
(146, 146, 'en', 'interdril.module.slideshows::field.publish.label.services', 'interdril.module.slideshows::field.publish.warning.services', 'interdril.module.slideshows::field.publish.placeholder.services', 'interdril.module.slideshows::field.publish.instructions.services'),
(147, 147, 'en', 'interdril.module.slideshows::field.title.label.products', 'interdril.module.slideshows::field.title.warning.products', 'interdril.module.slideshows::field.title.placeholder.products', 'interdril.module.slideshows::field.title.instructions.products'),
(148, 148, 'en', 'interdril.module.slideshows::field.slug.label.products', 'interdril.module.slideshows::field.slug.warning.products', 'interdril.module.slideshows::field.slug.placeholder.products', 'interdril.module.slideshows::field.slug.instructions.products'),
(149, 149, 'en', 'interdril.module.slideshows::field.image.label.products', 'interdril.module.slideshows::field.image.warning.products', 'interdril.module.slideshows::field.image.placeholder.products', 'interdril.module.slideshows::field.image.instructions.products'),
(150, 150, 'en', 'interdril.module.slideshows::field.url.label.products', 'interdril.module.slideshows::field.url.warning.products', 'interdril.module.slideshows::field.url.placeholder.products', 'interdril.module.slideshows::field.url.instructions.products'),
(151, 151, 'en', 'interdril.module.slideshows::field.publish.label.products', 'interdril.module.slideshows::field.publish.warning.products', 'interdril.module.slideshows::field.publish.placeholder.products', 'interdril.module.slideshows::field.publish.instructions.products'),
(152, 152, 'en', 'interdril.module.slideshows::field.image.label.partners', 'interdril.module.slideshows::field.image.warning.partners', 'interdril.module.slideshows::field.image.placeholder.partners', 'interdril.module.slideshows::field.image.instructions.partners'),
(153, 153, 'en', 'interdril.module.slideshows::field.publish.label.partners', 'interdril.module.slideshows::field.publish.warning.partners', 'interdril.module.slideshows::field.publish.placeholder.partners', 'interdril.module.slideshows::field.publish.instructions.partners');
...
(123, 'slideshows', 'title', 'anomaly.field_type.text', 'a:0:{}', 1),
(124, 'slideshows', 'parent_id', 'anomaly.field_type.integer', 'a:0:{}', 1),
(125, 'slideshows', 'slug', 'anomaly.field_type.text', 'a:2:{s:7:\"slugify\";s:5:\"title\";s:4:\"type\";s:1:\"_\";}', 1),
(126, 'slideshows', 'publish', 'anomaly.field_type.boolean', 'a:2:{s:13:\"default_value\";b:1;s:4:\"mode\";s:5:\"radio\";}', 1),
(127, 'slideshows', 'image', 'anomaly.field_type.file', 'a:0:{}', 1),
(128, 'slideshows', 'url', 'anomaly.field_type.url', 'a:0:{}', 1),
(129, 'slideshows', 'data_index', 'anomaly.field_type.text', 'a:0:{}', 1),
(130, 'slideshows', 'data_transition', 'anomaly.field_type.text', 'a:0:{}', 1),
(131, 'slideshows', 'data_slot_amount', 'anomaly.field_type.text', 'a:0:{}', 1),
(132, 'slideshows', 'data_hide_after_loop', 'anomaly.field_type.text', 'a:0:{}', 1),
(133, 'slideshows', 'data_hide_slide_on_mobile', 'anomaly.field_type.text', 'a:0:{}', 1),
(134, 'slideshows', 'data_ease_in', 'anomaly.field_type.text', 'a:0:{}', 1),
(135, 'slideshows', 'data_ease_out', 'anomaly.field_type.text', 'a:0:{}', 1),
(136, 'slideshows', 'data_master_speed', 'anomaly.field_type.text', 'a:0:{}', 1),
(137, 'slideshows', 'data_thumb', 'anomaly.field_type.text', 'a:0:{}', 1),
(138, 'slideshows', 'data_rotate', 'anomaly.field_type.text', 'a:0:{}', 1),
(139, 'slideshows', 'data_save_performance', 'anomaly.field_type.text', 'a:0:{}', 1),
(140, 'slideshows', 'data_title', 'anomaly.field_type.text', 'a:0:{}', 1),
(141, 'slideshows', 'data_param', 'anomaly.field_type.text', 'a:0:{}', 1),
(142, 'slideshows', 'data_description', 'anomaly.field_type.text', 'a:0:{}', 1),
(143, 'slideshows', 'data_bg_position', 'anomaly.field_type.text', 'a:0:{}', 1),
(144, 'slideshows', 'data_bg_fit', 'anomaly.field_type.text', 'a:0:{}', 1),
(145, 'slideshows', 'data_bg_repeat', 'anomaly.field_type.text', 'a:0:{}', 1),
(146, 'slideshows', 'class', 'anomaly.field_type.text', 'a:0:{}', 1),
(147, 'slideshows', 'data_no_retina', 'anomaly.field_type.text', 'a:0:{}', 1),
(148, 'slideshows', 'layer_class', 'anomaly.field_type.text', 'a:0:{}', 1),
(149, 'slideshows', 'layer_id', 'anomaly.field_type.text', 'a:0:{}', 1),
(150, 'slideshows', 'layer_data_x', 'anomaly.field_type.text', 'a:0:{}', 1),
(151, 'slideshows', 'layer_data_y', 'anomaly.field_type.text', 'a:0:{}', 1),
(152, 'slideshows', 'layer_data_width', 'anomaly.field_type.text', 'a:0:{}', 1),
(153, 'slideshows', 'layer_data_height', 'anomaly.field_type.text', 'a:0:{}', 1),
(154, 'slideshows', 'layer_data_type', 'anomaly.field_type.text', 'a:0:{}', 1),
(155, 'slideshows', 'layer_data_responsive_offset', 'anomaly.field_type.text', 'a:0:{}', 1),
(156, 'slideshows', 'layer_data_frames', 'anomaly.field_type.text', 'a:0:{}', 1),
(157, 'slideshows', 'layer_data_text_align', 'anomaly.field_type.text', 'a:0:{}', 1),
(158, 'slideshows', 'layer_data_padding_top', 'anomaly.field_type.text', 'a:0:{}', 1),
(159, 'slideshows', 'layer_data_padding_right', 'anomaly.field_type.text', 'a:0:{}', 1),
(160, 'slideshows', 'layer_data_padding_bottom', 'anomaly.field_type.text', 'a:0:{}', 1),
(161, 'slideshows', 'layer_data_padding_left', 'anomaly.field_type.text', 'a:0:{}', 1),
(162, 'slideshows', 'layer_image', 'anomaly.field_type.file', 'a:0:{}', 1),
(163, 'slideshows', 'layer_image_data_ww', 'anomaly.field_type.text', 'a:0:{}', 1),
(164, 'slideshows', 'layer_image_data_hh', 'anomaly.field_type.text', 'a:0:{}', 1),
(165, 'slideshows', 'layer_image_data_width', 'anomaly.field_type.text', 'a:0:{}', 1),
(166, 'slideshows', 'layer_image_data_height', 'anomaly.field_type.text', 'a:0:{}', 1),
(167, 'slideshows', 'layer_image_data_no_retina', 'anomaly.field_type.text', 'a:0:{}', 1),
(168, 'slideshows', 'layer_style', 'anomaly.field_type.text', 'a:0:{}', 1);
...
(123, 123, 'en', 'interdril.module.slideshows::field.title.name', 'interdril.module.slideshows::field.title.placeholder', 'interdril.module.slideshows::field.title.warning', 'interdril.module.slideshows::field.title.instructions'),
(124, 124, 'en', 'interdril.module.slideshows::field.parent_id.name', 'interdril.module.slideshows::field.parent_id.placeholder', 'interdril.module.slideshows::field.parent_id.warning', 'interdril.module.slideshows::field.parent_id.instructions'),
(125, 125, 'en', 'interdril.module.slideshows::field.slug.name', 'interdril.module.slideshows::field.slug.placeholder', 'interdril.module.slideshows::field.slug.warning', 'interdril.module.slideshows::field.slug.instructions'),
(126, 126, 'en', 'interdril.module.slideshows::field.publish.name', 'interdril.module.slideshows::field.publish.placeholder', 'interdril.module.slideshows::field.publish.warning', 'interdril.module.slideshows::field.publish.instructions'),
(127, 127, 'en', 'interdril.module.slideshows::field.image.name', 'interdril.module.slideshows::field.image.placeholder', 'interdril.module.slideshows::field.image.warning', 'interdril.module.slideshows::field.image.instructions'),
(128, 128, 'en', 'interdril.module.slideshows::field.url.name', 'interdril.module.slideshows::field.url.placeholder', 'interdril.module.slideshows::field.url.warning', 'interdril.module.slideshows::field.url.instructions'),
(129, 129, 'en', 'interdril.module.slideshows::field.data_index.name', 'interdril.module.slideshows::field.data_index.placeholder', 'interdril.module.slideshows::field.data_index.warning', 'interdril.module.slideshows::field.data_index.instructions'),
(130, 130, 'en', 'interdril.module.slideshows::field.data_transition.name', 'interdril.module.slideshows::field.data_transition.placeholder', 'interdril.module.slideshows::field.data_transition.warning', 'interdril.module.slideshows::field.data_transition.instructions'),
(131, 131, 'en', 'interdril.module.slideshows::field.data_slot_amount.name', 'interdril.module.slideshows::field.data_slot_amount.placeholder', 'interdril.module.slideshows::field.data_slot_amount.warning', 'interdril.module.slideshows::field.data_slot_amount.instructions'),
(132, 132, 'en', 'interdril.module.slideshows::field.data_hide_after_loop.name', 'interdril.module.slideshows::field.data_hide_after_loop.placeholder', 'interdril.module.slideshows::field.data_hide_after_loop.warning', 'interdril.module.slideshows::field.data_hide_after_loop.instructions'),
(133, 133, 'en', 'interdril.module.slideshows::field.data_hide_slide_on_mobile.name', 'interdril.module.slideshows::field.data_hide_slide_on_mobile.placeholder', 'interdril.module.slideshows::field.data_hide_slide_on_mobile.warning', 'interdril.module.slideshows::field.data_hide_slide_on_mobile.instructions'),
(134, 134, 'en', 'interdril.module.slideshows::field.data_ease_in.name', 'interdril.module.slideshows::field.data_ease_in.placeholder', 'interdril.module.slideshows::field.data_ease_in.warning', 'interdril.module.slideshows::field.data_ease_in.instructions'),
(135, 135, 'en', 'interdril.module.slideshows::field.data_ease_out.name', 'interdril.module.slideshows::field.data_ease_out.placeholder', 'interdril.module.slideshows::field.data_ease_out.warning', 'interdril.module.slideshows::field.data_ease_out.instructions'),
(136, 136, 'en', 'interdril.module.slideshows::field.data_master_speed.name', 'interdril.module.slideshows::field.data_master_speed.placeholder', 'interdril.module.slideshows::field.data_master_speed.warning', 'interdril.module.slideshows::field.data_master_speed.instructions'),
(137, 137, 'en', 'interdril.module.slideshows::field.data_thumb.name', 'interdril.module.slideshows::field.data_thumb.placeholder', 'interdril.module.slideshows::field.data_thumb.warning', 'interdril.module.slideshows::field.data_thumb.instructions'),
(138, 138, 'en', 'interdril.module.slideshows::field.data_rotate.name', 'interdril.module.slideshows::field.data_rotate.placeholder', 'interdril.module.slideshows::field.data_rotate.warning', 'interdril.module.slideshows::field.data_rotate.instructions'),
(139, 139, 'en', 'interdril.module.slideshows::field.data_save_performance.name', 'interdril.module.slideshows::field.data_save_performance.placeholder', 'interdril.module.slideshows::field.data_save_performance.warning', 'interdril.module.slideshows::field.data_save_performance.instructions'),
(140, 140, 'en', 'interdril.module.slideshows::field.data_title.name', 'interdril.module.slideshows::field.data_title.placeholder', 'interdril.module.slideshows::field.data_title.warning', 'interdril.module.slideshows::field.data_title.instructions'),
(141, 141, 'en', 'interdril.module.slideshows::field.data_param.name', 'interdril.module.slideshows::field.data_param.placeholder', 'interdril.module.slideshows::field.data_param.warning', 'interdril.module.slideshows::field.data_param.instructions'),
(142, 142, 'en', 'interdril.module.slideshows::field.data_description.name', 'interdril.module.slideshows::field.data_description.placeholder', 'interdril.module.slideshows::field.data_description.warning', 'interdril.module.slideshows::field.data_description.instructions'),
(143, 143, 'en', 'interdril.module.slideshows::field.data_bg_position.name', 'interdril.module.slideshows::field.data_bg_position.placeholder', 'interdril.module.slideshows::field.data_bg_position.warning', 'interdril.module.slideshows::field.data_bg_position.instructions'),
(144, 144, 'en', 'interdril.module.slideshows::field.data_bg_fit.name', 'interdril.module.slideshows::field.data_bg_fit.placeholder', 'interdril.module.slideshows::field.data_bg_fit.warning', 'interdril.module.slideshows::field.data_bg_fit.instructions'),
(145, 145, 'en', 'interdril.module.slideshows::field.data_bg_repeat.name', 'interdril.module.slideshows::field.data_bg_repeat.placeholder', 'interdril.module.slideshows::field.data_bg_repeat.warning', 'interdril.module.slideshows::field.data_bg_repeat.instructions'),
(146, 146, 'en', 'interdril.module.slideshows::field.class.name', 'interdril.module.slideshows::field.class.placeholder', 'interdril.module.slideshows::field.class.warning', 'interdril.module.slideshows::field.class.instructions'),
(147, 147, 'en', 'interdril.module.slideshows::field.data_no_retina.name', 'interdril.module.slideshows::field.data_no_retina.placeholder', 'interdril.module.slideshows::field.data_no_retina.warning', 'interdril.module.slideshows::field.data_no_retina.instructions'),
(148, 148, 'en', 'interdril.module.slideshows::field.layer_class.name', 'interdril.module.slideshows::field.layer_class.placeholder', 'interdril.module.slideshows::field.layer_class.warning', 'interdril.module.slideshows::field.layer_class.instructions'),
(149, 149, 'en', 'interdril.module.slideshows::field.layer_id.name', 'interdril.module.slideshows::field.layer_id.placeholder', 'interdril.module.slideshows::field.layer_id.warning', 'interdril.module.slideshows::field.layer_id.instructions'),
(150, 150, 'en', 'interdril.module.slideshows::field.layer_data_x.name', 'interdril.module.slideshows::field.layer_data_x.placeholder', 'interdril.module.slideshows::field.layer_data_x.warning', 'interdril.module.slideshows::field.layer_data_x.instructions'),
(151, 151, 'en', 'interdril.module.slideshows::field.layer_data_y.name', 'interdril.module.slideshows::field.layer_data_y.placeholder', 'interdril.module.slideshows::field.layer_data_y.warning', 'interdril.module.slideshows::field.layer_data_y.instructions'),
(152, 152, 'en', 'interdril.module.slideshows::field.layer_data_width.name', 'interdril.module.slideshows::field.layer_data_width.placeholder', 'interdril.module.slideshows::field.layer_data_width.warning', 'interdril.module.slideshows::field.layer_data_width.instructions'),
(153, 153, 'en', 'interdril.module.slideshows::field.layer_data_height.name', 'interdril.module.slideshows::field.layer_data_height.placeholder', 'interdril.module.slideshows::field.layer_data_height.warning', 'interdril.module.slideshows::field.layer_data_height.instructions'),
(154, 154, 'en', 'interdril.module.slideshows::field.layer_data_type.name', 'interdril.module.slideshows::field.layer_data_type.placeholder', 'interdril.module.slideshows::field.layer_data_type.warning', 'interdril.module.slideshows::field.layer_data_type.instructions'),
(155, 155, 'en', 'interdril.module.slideshows::field.layer_data_responsive_offset.name', 'interdril.module.slideshows::field.layer_data_responsive_offset.placeholder', 'interdril.module.slideshows::field.layer_data_responsive_offset.warning', 'interdril.module.slideshows::field.layer_data_responsive_offset.instructions'),
(156, 156, 'en', 'interdril.module.slideshows::field.layer_data_frames.name', 'interdril.module.slideshows::field.layer_data_frames.placeholder', 'interdril.module.slideshows::field.layer_data_frames.warning', 'interdril.module.slideshows::field.layer_data_frames.instructions'),
(157, 157, 'en', 'interdril.module.slideshows::field.layer_data_text_align.name', 'interdril.module.slideshows::field.layer_data_text_align.placeholder', 'interdril.module.slideshows::field.layer_data_text_align.warning', 'interdril.module.slideshows::field.layer_data_text_align.instructions'),
(158, 158, 'en', 'interdril.module.slideshows::field.layer_data_padding_top.name', 'interdril.module.slideshows::field.layer_data_padding_top.placeholder', 'interdril.module.slideshows::field.layer_data_padding_top.warning', 'interdril.module.slideshows::field.layer_data_padding_top.instructions'),
(159, 159, 'en', 'interdril.module.slideshows::field.layer_data_padding_right.name', 'interdril.module.slideshows::field.layer_data_padding_right.placeholder', 'interdril.module.slideshows::field.layer_data_padding_right.warning', 'interdril.module.slideshows::field.layer_data_padding_right.instructions'),
(160, 160, 'en', 'interdril.module.slideshows::field.layer_data_padding_bottom.name', 'interdril.module.slideshows::field.layer_data_padding_bottom.placeholder', 'interdril.module.slideshows::field.layer_data_padding_bottom.warning', 'interdril.module.slideshows::field.layer_data_padding_bottom.instructions'),
(161, 161, 'en', 'interdril.module.slideshows::field.layer_data_padding_left.name', 'interdril.module.slideshows::field.layer_data_padding_left.placeholder', 'interdril.module.slideshows::field.layer_data_padding_left.warning', 'interdril.module.slideshows::field.layer_data_padding_left.instructions'),
(162, 162, 'en', 'interdril.module.slideshows::field.layer_image.name', 'interdril.module.slideshows::field.layer_image.placeholder', 'interdril.module.slideshows::field.layer_image.warning', 'interdril.module.slideshows::field.layer_image.instructions'),
(163, 163, 'en', 'interdril.module.slideshows::field.layer_image_data_ww.name', 'interdril.module.slideshows::field.layer_image_data_ww.placeholder', 'interdril.module.slideshows::field.layer_image_data_ww.warning', 'interdril.module.slideshows::field.layer_image_data_ww.instructions'),
(164, 164, 'en', 'interdril.module.slideshows::field.layer_image_data_hh.name', 'interdril.module.slideshows::field.layer_image_data_hh.placeholder', 'interdril.module.slideshows::field.layer_image_data_hh.warning', 'interdril.module.slideshows::field.layer_image_data_hh.instructions'),
(165, 165, 'en', 'interdril.module.slideshows::field.layer_image_data_width.name', 'interdril.module.slideshows::field.layer_image_data_width.placeholder', 'interdril.module.slideshows::field.layer_image_data_width.warning', 'interdril.module.slideshows::field.layer_image_data_width.instructions'),
(166, 166, 'en', 'interdril.module.slideshows::field.layer_image_data_height.name', 'interdril.module.slideshows::field.layer_image_data_height.placeholder', 'interdril.module.slideshows::field.layer_image_data_height.warning', 'interdril.module.slideshows::field.layer_image_data_height.instructions'),
(167, 167, 'en', 'interdril.module.slideshows::field.layer_image_data_no_retina.name', 'interdril.module.slideshows::field.layer_image_data_no_retina.placeholder', 'interdril.module.slideshows::field.layer_image_data_no_retina.warning', 'interdril.module.slideshows::field.layer_image_data_no_retina.instructions'),
(168, 168, 'en', 'interdril.module.slideshows::field.layer_style.name', 'interdril.module.slideshows::field.layer_style.placeholder', 'interdril.module.slideshows::field.layer_style.warning', 'interdril.module.slideshows::field.layer_style.instructions');
...
(29, 'slideshows', 'slideshows', 'slideshows_', 'title', 'id', 0, 0, 1, 1, 0, 1, 'a:0:{}'),
(30, 'slideshows', 'promises', 'slideshows_', 'title', 'id', 0, 0, 1, 1, 0, 1, 'a:0:{}'),
(31, 'slideshows', 'services', 'slideshows_', 'title', 'id', 0, 0, 1, 1, 0, 1, 'a:0:{}'),
(32, 'slideshows', 'products', 'slideshows_', 'title', 'id', 0, 0, 1, 1, 0, 1, 'a:0:{}'),
(33, 'slideshows', 'partners', 'slideshows_', 'name', 'id', 0, 0, 1, 1, 0, 1, 'a:0:{}'),
(34, 'files', 'slideshows', 'files_', 'id', 'id', 0, 0, 0, 0, 1, 1, 'a:0:{}'),
(35, 'files', 'promises', 'files_', 'id', 'id', 0, 0, 0, 0, 1, 1, 'a:0:{}');
...
(29, 29, 'en', 'interdril.module.slideshows::stream.slideshows.name', 'interdril.module.slideshows::stream.slideshows.description'),
(30, 30, 'en', 'interdril.module.slideshows::stream.promises.name', 'interdril.module.slideshows::stream.promises.description'),
(31, 31, 'en', 'interdril.module.slideshows::stream.services.name', 'interdril.module.slideshows::stream.services.description'),
(32, 32, 'en', 'interdril.module.slideshows::stream.products.name', 'interdril.module.slideshows::stream.products.description'),
(33, 33, 'en', 'interdril.module.slideshows::stream.partners.name', 'interdril.module.slideshows::stream.partners.description'),
(34, 34, 'en', 'Slideshows', 'Slideshows Image'),
(35, 35, 'en', 'Promises', 'Promises');
...
(1, 1, '2017-07-18 03:05:11', NULL, '2017-07-21 08:10:52', 1, NULL, 'admin@interdril.com', 'admin', '$2y$10$IpPB/HG/IyhlVR4R0VesIefJFPTxRSieQMdT5J480OM5dtLVfTX0q', 'Administrator', NULL, NULL, 1, 1, NULL, '2017-07-21 08:10:52', NULL, NULL, NULL, NULL, NULL),
...
--
-- Indexes for table `interdril_files_promises`
--
ALTER TABLE `interdril_files_promises`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `interdril_files_promises_translations`
--
ALTER TABLE `interdril_files_promises_translations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `files_promises_translations_locale_index` (`locale`);
...
--
-- Indexes for table `interdril_files_slideshows`
--
ALTER TABLE `interdril_files_slideshows`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `interdril_files_slideshows_translations`
--
ALTER TABLE `interdril_files_slideshows_translations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `files_slideshows_translations_locale_index` (`locale`);
...
--
-- Indexes for table `interdril_slideshows_partners`
--
ALTER TABLE `interdril_slideshows_partners`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `interdril_slideshows_partners_translations`
--
ALTER TABLE `interdril_slideshows_partners_translations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `slideshows_partners_translations_locale_index` (`locale`);

--
-- Indexes for table `interdril_slideshows_products`
--
ALTER TABLE `interdril_slideshows_products`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `dbfd362004f363cedb00b4b4f939483c` (`slug`);

--
-- Indexes for table `interdril_slideshows_products_translations`
--
ALTER TABLE `interdril_slideshows_products_translations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `slideshows_products_translations_locale_index` (`locale`);

--
-- Indexes for table `interdril_slideshows_promises`
--
ALTER TABLE `interdril_slideshows_promises`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `8dca40bfb694f98a0a355ff5277cf9eb` (`slug`);

--
-- Indexes for table `interdril_slideshows_promises_translations`
--
ALTER TABLE `interdril_slideshows_promises_translations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `slideshows_promises_translations_locale_index` (`locale`);

--
-- Indexes for table `interdril_slideshows_services`
--
ALTER TABLE `interdril_slideshows_services`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `f9411140cbf6b32d7f13bdf21f5d7384` (`slug`);

--
-- Indexes for table `interdril_slideshows_services_translations`
--
ALTER TABLE `interdril_slideshows_services_translations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `slideshows_services_translations_locale_index` (`locale`);

--
-- Indexes for table `interdril_slideshows_slideshows`
--
ALTER TABLE `interdril_slideshows_slideshows`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `47a83b26fda144654703b2bfadd3a413` (`slug`);

--
-- Indexes for table `interdril_slideshows_slideshows_translations`
--
ALTER TABLE `interdril_slideshows_slideshows_translations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `slideshows_slideshows_translations_locale_index` (`locale`);
...
ALTER TABLE `interdril_files_images_translations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `interdril_files_promises`
--
ALTER TABLE `interdril_files_promises`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `interdril_files_promises_translations`
--
ALTER TABLE `interdril_files_promises_translations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `interdril_files_services_translations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `interdril_files_slideshows`
--
ALTER TABLE `interdril_files_slideshows`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `interdril_files_slideshows_translations`
--
ALTER TABLE `interdril_files_slideshows_translations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `interdril_slideshows_partners`
--
ALTER TABLE `interdril_slideshows_partners`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `interdril_slideshows_partners_translations`
--
ALTER TABLE `interdril_slideshows_partners_translations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `interdril_slideshows_products`
--
ALTER TABLE `interdril_slideshows_products`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `interdril_slideshows_products_translations`
--
ALTER TABLE `interdril_slideshows_products_translations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `interdril_slideshows_promises`
--
ALTER TABLE `interdril_slideshows_promises`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `interdril_slideshows_promises_translations`
--
ALTER TABLE `interdril_slideshows_promises_translations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `interdril_slideshows_services`
--
ALTER TABLE `interdril_slideshows_services`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `interdril_slideshows_services_translations`
--
ALTER TABLE `interdril_slideshows_services_translations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `interdril_slideshows_slideshows`
--
ALTER TABLE `interdril_slideshows_slideshows`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `interdril_slideshows_slideshows_translations`
--
ALTER TABLE `interdril_slideshows_slideshows_translations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
