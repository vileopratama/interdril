...
(2, 4, '2017-07-18 03:05:02', NULL, '2017-07-19 09:33:08', 1, NULL, 'OeGKP4lQdqKwGPXQ6FeKMFxa', 'contact', '/contact', 1, 2, 'Anomaly\\Streams\\Platform\\Model\\Pages\\PagesDefaultPagesEntryModel', NULL, 1, 1, 1, 0, 'theme::layouts/default.twig'),
...
(7, 7, '2017-07-19 09:36:24', 1, '2017-07-19 09:55:31', 1, NULL, 'QJMs9Psy2J5MsA1YnBLIRIHY', 'rotary-drilling', '/product/rotary-drilling', 2, 1, 'Anomaly\\Streams\\Platform\\Model\\Pages\\PagesPageWithAnimationImagePagesEntryModel', 6, 1, 1, 1, 0, NULL);
...
INSERT INTO `interdril_pages_page_with_animation_image_pages` (`id`, `sort_order`, `created_at`, `created_by_id`, `updated_at`, `updated_by_id`, `deleted_at`) VALUES
(1, 1, '2017-07-19 09:36:23', 1, NULL, NULL, NULL);
...
(2, 2, '2017-07-19 09:29:21', 1, '2017-07-19 09:49:04', 1, NULL, 'page_with_animation_image', 'theme::layouts.default', '<section class=\"col-md-12 col-sm-12\">\r\n	{{ page.content|raw }}\r\n</section>\r\n<div class=\"row\" id=\"slide-image\">\r\n	<div class=\"row mx-content center\">\r\n        <h3 class=\"title\"><span>{{ page.title|raw }}</span></h3>\r\n    </div>\r\n	{% for image in page.images %}\r\n	<div class=\"col-md-3 col-sm-4\"><img class=\"animate\" src=\"{{ image.make().url() }}\" alt=\"{{ image.keyword }}\" data-effect=\"fadeInUp\" /></div>\r\n	{% endfor %}\r\n</div>', 'anomaly.extension.default_page_handler');
...
(127, 127, 26, 117, 'a:1:{i:0;s:6:\"a:0:{}\";}', 0, 1, 0),
(128, 128, 26, 41, 'a:1:{i:0;s:6:\"a:0:{}\";}', 0, 1, 1);
...
(1, 1, '2017-07-18 03:05:11', NULL, '2017-07-19 08:52:02', 1, NULL, 'admin@interdril.com', 'admin', '$2y$10$IpPB/HG/IyhlVR4R0VesIefJFPTxRSieQMdT5J480OM5dtLVfTX0q', 'Administrator', NULL, NULL, 1, 1, NULL, '2017-07-19 08:52:02', NULL, NULL, NULL, NULL, NULL),
